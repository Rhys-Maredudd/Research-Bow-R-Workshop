...
If this is misbehaving/too tricky, we will use the url option below, that will read the file directly from github.
...
```{r url_method}
df_raw <- read_csv(url("https://raw.github.com/Rhys-Maredudd/Research-Bow-R-Workshop/main/~survey_data.csv"))
